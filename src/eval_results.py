...
def plot_main_results():
    #fig , (ax11, ax12) = plt.subplots(1, 2, figsize=(10, 3), sharex=True)
    ...
    ax11.set_ylabel("$F_1$")
    ax11.set_xlabel("$\\beta = 1$")
    ax12.set_xlabel("$\\beta = 1/2$")
    ...
    fig.legend(Line, Label, loc="upper center", bbox_to_anchor=(0.5, 1.1), ncol=2)
    plt.tight_layout()

    plt.savefig("figures/metrics_final_eval_thesis.pdf", bbox_inches="tight")
    plt.show()
